...
void PrintConfigDef::init_common_params()
{
    ...
    def->tooltip = L("Cosmos3D can upload G-code files to a printer host. This field should contain "
...
void PrintConfigDef::init_fff_params()
{
    ...
    def->enum_labels.emplace_back(L("Ground"));
    ...
    */
    ...
    def->tooltip = L("Connect an infill line to an internal perimeter with a short segment of an additional perimeter. "
                     ...
                     "Cosmos3D tries to connect two close infill lines to a short perimeter segment. If no such perimeter segment "
    ...
    def->tooltip = L("Cosmos3D can upload G-code files to a printer host. This field must contain "
