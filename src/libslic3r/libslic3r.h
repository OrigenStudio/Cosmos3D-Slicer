...
#define SLIC3R_APP_FULL_NAME "Cosmos3D"
#define GCODEVIEWER_APP_NAME "Cosmos3D G-code Viewer"
#define GCODEVIEWER_APP_KEY  "Cosmos3DGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("Cosmos3D G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
