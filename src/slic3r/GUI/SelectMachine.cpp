...
void SelectMachinePopup::update_other_devices()
{
    ...
    m_hyperlink->SetNormalColour(StateColor::darkModeColorFor("#4872E3"));
    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    m_ams_backup_tip->SetForegroundColour(wxColour(0x4872E3));
    ...
    m_btn_bg_enable = StateColor(std::pair<wxColour, int>(wxColour(46, 103, 255), StateColor::Pressed), std::pair<wxColour, int>(wxColour(0, 133, 232), StateColor::Hovered),
    ...
    m_statictext_finish->SetForegroundColour(wxColour(72, 114, 227));
