...
wxBoxSizer* FileArchiveDialog::create_btn_sizer()
{
    ...
    auto apply_highlighted_btn_colors = [](Button* btn) {
        btn->SetBackgroundColor(StateColor(std::pair<wxColour, int>(wxColour(46, 103, 255), StateColor::Pressed),
                                           std::pair<wxColour, int>(wxColour(0, 133, 232), StateColor::Hovered),
                                           std::pair<wxColour, int>(wxColour(72, 114, 227), StateColor::Normal)));

        btn->SetBorderColor(StateColor(std::pair<wxColour, int>(wxColour(72, 114, 227), StateColor::Normal)));
