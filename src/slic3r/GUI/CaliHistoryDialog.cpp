    ...
    , m_show_history_dialog(show)
{
    ...
    mew_btn->SetBorderColor(wxColour(72, 114, 227));
...
void HistoryWindow::sync_history_data() {
    ...
    for (auto& result : m_calib_results_history) {
        ...
        StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(46, 103, 255), StateColor::Pressed),
        ...
        edit_button->SetBorderColor(wxColour(72, 114, 227));
    ...
    , m_new_result(result)
{
    ...
    save_btn->SetBorderColor(wxColour(72, 114, 227));
    ...
    , m_history_results(history_results)
{
    ...
    ok_btn->SetBorderColor(wxColour(72, 114, 227));
