...
/*#ifdef __WXOSX__
    ...
    StateColor box_border_colour(std::pair<wxColour, int>(wxColour("#4872E3"), StateColor::Normal)); // ORCA match border color with other input/combo boxes
...
void TabPrint::build()
{
    ...
    auto page = add_options_page(L("Quality"), "custom-gcode_quality"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("seam_slope_ramp_only", "quality_settings_seam#scarf-joint-seam");
