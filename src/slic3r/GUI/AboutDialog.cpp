    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, Slic3r::var("Cosmos3D_192px.png"), wxBITMAP_TYPE_PNG);
...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("Cosmos3D is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("Cosmos3D is based on PrusaSlicer and BambuStudio"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, is_dark ? "Cosmos3D_about_dark" : "Cosmos3D_about", 125);
    ...
    // version
    {
        ...
        auto          version_string = std::string(SoftFever_VERSION); // _L("Cosmos3D ") + " " + std::string(SoftFever_VERSION);
...
// #endif
    ...
    text_list.push_back(_L("Cosmos3D is based on BambuStudio, PrusaSlicer, and SuperSlicer."));
