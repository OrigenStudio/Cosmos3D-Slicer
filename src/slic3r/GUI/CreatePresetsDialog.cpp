...
#define SELECT_ALL_OPTION_COLOUR wxColour("#4872E3")
...
static const std::vector<std::string> filament_types = {"PLA",    "rPLA",  "PLA+",      "PLA Tough", "PETG",  "ABS",    "ASA",    "FLEX",   "HIPS",   "PA",     "PACF",
                                                        ...
                                                        "TPE",    "GLAZE", "Nylon",     "CPE",   "METAL",  "ABST",   "Carbon Fiber", "Concrete"};

static const std::vector<std::string> printer_vendors = {"Cosmos3D"};
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(72, 114, 227), StateColor::Pressed), std::pair<wxColour, int>(wxColour(72, 114, 227), StateColor::Hovered),
