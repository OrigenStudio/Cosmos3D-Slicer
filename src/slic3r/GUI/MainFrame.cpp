...
#else // _WIN32
    return wxIcon(Slic3r::var("Cosmos3D_128px.png"), wxBITMAP_TYPE_PNG);
#endif // _WIN32
}
...
*/
    ...
    case GUI_App::EAppMode::Editor:
        ...
        m_taskbar_icon->SetIcon(wxIcon(Slic3r::var("cosmos3d_logo.ico"), wxBITMAP_TYPE_ICO), "Cosmos3D Slicer");
        break;
...
#else
    SetIcon(wxIcon(var("Cosmos3D_128px.png"), wxBITMAP_TYPE_PNG));
#endif // _WIN32
