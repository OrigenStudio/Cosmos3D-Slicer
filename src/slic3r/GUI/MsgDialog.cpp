...
Button* MsgDialog::add_button(wxWindowID btn_id, bool set_focus /*= false*/, const wxString& label/* = wxString()*/)
{
    ...
    StateColor btn_bg_green(
        std::pair<wxColour, int>(wxColour(46, 103, 255), StateColor::Pressed),
        std::pair<wxColour, int>(wxColour(0, 133, 232), StateColor::Hovered),
...
void MsgDialog::apply_style(long style)
{
    ...
    logo->SetBitmap( create_scaled_bitmap(style & wxAPPLY        ? "completed" :
                                          ...
                                          style & wxICON_QUESTION       ? "question"    : "Cosmos3D", this, 64, style & wxICON_ERROR));
}
	...
	, msg(msg)
{
	...
	logo->SetBitmap(create_scaled_bitmap("Cosmos3D_192px_grayscale.png", this, monospaced_font ? 48 : /*1*/84));
...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) { 
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3mf file version is in Beta and it is newer than the current Cosmos3D version."));
        wxStaticText *   text2       = new wxStaticText(this, wxID_ANY, _L("If you would like to try Cosmos3D Beta, you may click to"));
        ...
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3mf file version is newer than the current Cosmos3D version."));
        wxStaticText *text2 = new wxStaticText(this, wxID_ANY, _L("Update your Cosmos3D could enable all functionality in the 3mf file."));
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
    }
